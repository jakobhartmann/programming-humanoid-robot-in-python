...
class PIDController(object):
    ...
    def control(self, target, sensor):
        ...
        # https://www.researchgate.net/publication/320998425_Control_Theory_Tutorial_Basic_Concepts_Illustrated_by_Software_Examples, page 100
        # https://de.mathworks.com/help/control/ug/control-of-processes-with-long-dead-time-the-smith-predictor.html?w.mathworks.com
        # lecture 2, slide 8
        model_prediction = sensor + self.u * self.dt
        self.y.appendleft(model_prediction)
        e = target - ((sensor - model_prediction) + self.y.pop())
